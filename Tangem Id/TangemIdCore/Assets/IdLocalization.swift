...
struct IdLocalization {
	...
	struct Errors {
		...
		static let invalidCard = "invalid_card".localizedString()
		...
		static let noAvailablePublicCredentialsOnCard = "no_available_public_credentials_on_card".localizedString()
